...
var _sellorder = require('../../../../src/core/market/orders/sellorder');
...
describe('Sell Order', function () {
  it('The price and amount property need be instanciated and converted in satoshis.', function () {
    var order = new _sellorder2.default(9000, 0.123);
  ...
  it('The symbol need be the same of constants.', function () {
    var order = new _sellorder2.default(850, 1);
    _chai.assert.equal(order.symbol, _foxbitConstants2.default.DEFAULT_SYMBOL);
  });

  it('The side need be 2 (Sell).', function () {
    var order = new _sellorder2.default(1, 0.0001);
    _chai.assert.equal(order.side, '2');
  });

  it('Is same side should be true and without errors.', function () {
    var order = new _sellorder2.default(29000, 0.0124871);
  ...
  it('Is same side should be false and without errors.', function () {
    var order = new _sellorder2.default(250000, 2.124871);
  ...
  it('Is my price in top should return false and without errors.', function () {
    var order = new _sellorder2.default(25000, 2.124871);
  ...
  it('Price by books should return the value minus 0.01.', function () {
    var order = new _sellorder2.default(2100, 61.8412);
    var response = order.gePriceByOrderbook(22154.84);
    _chai.assert.equal(response, 22154.83);
  });
}); /* global describe it */